...
export default function BulkMarksEntryPage() {
  ...
  const [existingMarks, setExistingMarks] = useState<Map<number, ExistingMark>>(new Map());
      ...
      try {
        ...
        for (const exam of data) {
          ...
          if (examData.subjects) {
            allSubjects.push(...examData.subjects.map((s: any) => ({
              ...s,
              exam: examData
            })));
          }
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Enter marks for multiple students at once.</p>
      </div>
